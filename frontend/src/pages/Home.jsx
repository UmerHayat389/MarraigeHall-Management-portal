...
export default function Home() {
  ...
  return (
    <div style={{ background: "#0a0a0f", minHeight: "100vh", color: "white", fontFamily: "'DM Sans',sans-serif" }}>
      <style>{`
        ...
        .gold-dot::before { content:''; display:inline-block; width:5px; height:5px; background:#fbbf24; transform:rotate(45deg); margin-right:10px; vertical-align:middle; }
      ...
      <section style={{ minHeight: "100vh", position: "relative", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
        ...
        <div style={{ position: "absolute", top: "25%", left: "20%", width: "400px", height: "400px", borderRadius: "50%", background: "radial-gradient(circle,rgba(245,158,11,0.15),transparent)", filter: "blur(40px)" }} />
        <div style={{ position: "absolute", bottom: "30%", right: "20%", width: "300px", height: "300px", borderRadius: "50%", background: "radial-gradient(circle,rgba(15,118,110,0.12),transparent)", filter: "blur(40px)" }} />

        <div style={{ position: "relative", zIndex: 10, textAlign: "center", maxWidth: "900px", padding: "0 1.5rem" }}>
          <p className="anim-1 gold-dot" style={{ color: "#fbbf24", fontSize: "0.7rem", letterSpacing: "0.4em", textTransform: "uppercase", marginBottom: "1.5rem" }}>
          ...
          <h1 className="anim-2" style={{ fontFamily: "'Playfair Display',serif", fontSize: "clamp(3rem,7vw,5.5rem)", fontWeight: 300, lineHeight: 1.08, marginBottom: "1.5rem" }}>
            Where Every<br />
            <em style={{ color: "#fbbf24", fontStyle: "italic", fontWeight: 600 }}>Dream</em> Begins
          </h1>
          <p className="anim-3" style={{ color: "rgba(255,255,255,0.75)", fontSize: "1.1rem", maxWidth: "520px", margin: "0 auto 2.5rem", lineHeight: 1.7 }}>
          ...
          <div className="anim-4 hero-buttons">
            <button onClick={() => openModal()}
              style={{ padding: "1rem 2.5rem", borderRadius: "9999px", background: "linear-gradient(135deg,#d97706,#fbbf24)", color: "white", fontWeight: 600, fontSize: "0.95rem", border: "none", cursor: "pointer", boxShadow: "0 8px 30px rgba(245,158,11,0.4)", transition: "transform 0.2s" }}
            ...
            <a href="#halls"
              ...
              onMouseEnter={(e) => { e.currentTarget.style.color = "white"; e.currentTarget.style.borderColor = "rgba(245,158,11,0.5)"; }}
        ...
        <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "0 1.5rem 2rem" }}>
          <div style={{ maxWidth: "800px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "1px", borderRadius: "16px", overflow: "hidden", border: "1px solid rgba(245,158,11,0.15)" }}>
            {[["500+", "Events Hosted"], ["15+", "Years Excellence"], ["50,000+", "Happy Guests"]].map(([n, l]) => (
              <div key={l} style={{ textAlign: "center", padding: "1rem", background: "rgba(7,5,15,0.7)" }}>
                <p style={{ fontFamily: "'Playfair Display',serif", color: "#fbbf24", fontSize: "1.4rem", fontWeight: 700 }}>{n}</p>
                <p style={{ color: "rgba(255,255,255,0.65)", fontSize: "0.75rem", marginTop: "2px" }}>{l}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="halls" style={{ padding: "6rem 1.5rem" }}>
        <div style={{ maxWidth: "1152px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "3.5rem" }}>
            <p className="gold-dot" style={{ color: "#fbbf24", fontSize: "0.7rem", letterSpacing: "0.35em", textTransform: "uppercase", marginBottom: "0.75rem" }}>Our Venues</p>
            <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: "clamp(2rem,4vw,3rem)", fontWeight: 300 }}>
              Halls Built for <em style={{ color: "#fbbf24" }}>Grandeur</em>
            </h2>
          </div>
          {halls.length > 0 ? (
            ...
            <div className="halls-grid">
              {hallImages.map((img, i) => (
                <div key={i} style={{ borderRadius: "16px", overflow: "hidden", border: "1px solid rgba(245,158,11,0.12)", background: "rgba(255,255,255,0.02)", cursor: "pointer", transition: "transform 0.3s" }}
                  onClick={() => openModal()}
                  ...
                  <div style={{ padding: "1.25rem" }}>
                    <p style={{ color: "#fbbf24", fontSize: "0.65rem", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: "0.3rem" }}>Premium Venue</p>
      ...
      {/* ── PACKAGES ── */}
      <section id="packages" style={{ padding: "6rem 1.5rem", background: "rgba(245,158,11,0.04)" }}>
        <div style={{ maxWidth: "1152px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "3.5rem" }}>
            <p className="gold-dot" style={{ color: "#fbbf24", fontSize: "0.7rem", letterSpacing: "0.35em", textTransform: "uppercase", marginBottom: "0.75rem" }}>What We Offer</p>
            <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: "clamp(2rem,4vw,3rem)", fontWeight: 300 }}>
              Event <em style={{ color: "#fbbf24" }}>Packages</em>
            </h2>
          </div>
          <div className="packages-grid">
            {packages.map((pkg, i) => (
              <div key={i} style={{ borderRadius: "16px", padding: "1.5rem", border: "1px solid rgba(245,158,11,0.12)", background: "rgba(255,255,255,0.02)", transition: "transform 0.3s, box-shadow 0.3s" }}
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
                  <div>
                    <p style={{ color: "#fcd34d", fontWeight: 600 }}>{pkg.price}</p>
                    <p style={{ color: "rgba(255,255,255,0.55)", fontSize: "0.72rem" }}>{pkg.guests}</p>
                  </div>
                  <button onClick={() => openModal()}
                    style={{ fontSize: "0.75rem", padding: "0.4rem 1rem", borderRadius: "9999px", border: "1px solid rgba(245,158,11,0.3)", color: "#fcd34d", background: "transparent", cursor: "pointer", transition: "all 0.2s" }}
                    onMouseEnter={(e) => { e.currentTarget.style.background = "#e8a020"; e.currentTarget.style.color = "white"; }}
                    onMouseLeave={(e) => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.color = "#fcd34d"; }}>
                    Book
                  </button>
                </div>
              </div>
      ...
      <section id="about" style={{ padding: "6rem 1.5rem" }}>
        ...
        <div className="about-grid">
          <div>
            <p className="gold-dot" style={{ color: "#fbbf24", fontSize: "0.7rem", letterSpacing: "0.35em", textTransform: "uppercase", marginBottom: "0.75rem" }}>Our Story</p>
            <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: "clamp(1.8rem,3.5vw,2.8rem)", fontWeight: 300, marginBottom: "1.5rem", lineHeight: 1.2 }}>
              15 Years Creating<br /><em style={{ color: "#fbbf24" }}>Unforgettable</em> Moments
            </h2>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
              {[["5-Star", "Google Rating"], ["100%", "Client Satisfaction"], ["In-House", "Catering Team"], ["24/7", "Event Support"]].map(([n, l]) => (
                <div key={l} style={{ borderRadius: "12px", padding: "1rem", background: "rgba(245,158,11,0.06)", border: "1px solid rgba(245,158,11,0.12)" }}>
                  <p style={{ color: "#fcd34d", fontWeight: 700, fontSize: "1.1rem" }}>{n}</p>
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{ position: "absolute", bottom: "-1rem", left: "-1rem", borderRadius: "12px", padding: "1rem 1.5rem", background: "linear-gradient(135deg,#d97706,#fbbf24)" }}>
      ...
      {/* ── TESTIMONIALS ── */}
      <section id="testimonials" style={{ padding: "6rem 1.5rem", background: "rgba(245,158,11,0.04)" }}>
        <div style={{ maxWidth: "1152px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "3.5rem" }}>
            <p className="gold-dot" style={{ color: "#fbbf24", fontSize: "0.7rem", letterSpacing: "0.35em", textTransform: "uppercase", marginBottom: "0.75rem" }}>Happy Clients</p>
            <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: "clamp(2rem,4vw,3rem)", fontWeight: 300 }}>
              What Our <em style={{ color: "#fbbf24" }}>Guests</em> Say
            </h2>
          </div>
          <div className="testimonials-grid">
            {testimonials.map((t, i) => (
              <div key={i} style={{ borderRadius: "16px", padding: "1.75rem", border: "1px solid rgba(245,158,11,0.12)", background: "rgba(255,255,255,0.02)" }}>
                <div style={{ display: "flex", gap: "3px", marginBottom: "1rem" }}>
                  {[...Array(t.stars)].map((_, j) => <span key={j} style={{ color: "#fbbf24", fontSize: "0.9rem" }}>★</span>)}
                </div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                  <div style={{ width: "36px", height: "36px", borderRadius: "50%", background: "rgba(245,158,11,0.3)", display: "flex", alignItems: "center", justifyContent: "center", color: "#fcd34d", fontSize: "0.85rem", fontWeight: 700 }}>
                    {t.name[0]}
                  </div>
                  <div>
      ...
      <section id="contact" style={{ padding: "6rem 1.5rem" }}>
        <div style={{ maxWidth: "1152px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "3.5rem" }}>
            <p className="gold-dot" style={{ color: "#fbbf24", fontSize: "0.7rem", letterSpacing: "0.35em", textTransform: "uppercase", marginBottom: "0.75rem" }}>Get In Touch</p>
            <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: "clamp(2rem,4vw,3rem)", fontWeight: 300 }}>
              Plan Your <em style={{ color: "#fbbf24" }}>Dream Event</em>
            </h2>
          </div>
          <div className="contact-grid">
            {[["📍", "Location", "Clifton Block 5, Karachi"], ["📞", "Phone", "+92 21 3456 7890"], ["✉️", "Email", "bookings@noormahal.pk"]].map(([icon, label, val]) => (
              <div key={label} style={{ borderRadius: "16px", padding: "1.75rem", textAlign: "center", border: "1px solid rgba(245,158,11,0.12)", background: "rgba(255,255,255,0.02)" }}>
                <div style={{ fontSize: "1.75rem", marginBottom: "0.75rem" }}>{icon}</div>
                <p style={{ color: "#fbbf24", fontSize: "0.68rem", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: "0.3rem" }}>{label}</p>
          ...
          {/* CTA Banner */}
          <div style={{ borderRadius: "24px", padding: "4rem 2rem", textAlign: "center", position: "relative", overflow: "hidden", border: "1px solid rgba(245,158,11,0.2)", background: "linear-gradient(135deg,rgba(245,158,11,0.25),rgba(15,118,110,0.15))" }}>
            <p className="gold-dot" style={{ color: "#fcd34d", fontSize: "0.68rem", letterSpacing: "0.35em", textTransform: "uppercase", marginBottom: "0.75rem" }}>Ready to begin?</p>
            <h3 style={{ fontFamily: "'Playfair Display',serif", fontSize: "clamp(1.6rem,3vw,2.5rem)", fontWeight: 300, marginBottom: "1rem" }}>
              Book Your Event <em style={{ color: "#fbbf24" }}>Today</em>
            </h3>
            ...
            <button onClick={() => openModal()}
              style={{ padding: "1rem 3rem", borderRadius: "9999px", background: "linear-gradient(135deg,#d97706,#fbbf24)", color: "white", fontWeight: 600, fontSize: "0.95rem", border: "none", cursor: "pointer", boxShadow: "0 8px 30px rgba(245,158,11,0.4)", transition: "transform 0.2s" }}
              onMouseEnter={(e) => (e.currentTarget.style.transform = "scale(1.05)")}
              onMouseLeave={(e) => (e.currentTarget.style.transform = "scale(1)")}>
              Reserve Now
            </button>
      ...
      {/* ── FOOTER ── */}
      <footer style={{ borderTop: "1px solid rgba(245,158,11,0.1)", padding: "2.5rem 1.5rem" }}>
        <div style={{ maxWidth: "1152px", margin: "0 auto" }} className="footer-inner">
          ...
          <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "0.8rem" }}>© 2025 Noor Mahal. All rights reserved.</p>
          <div style={{ display: "flex", gap: "1.5rem" }}>
            <a href="/admin" style={{ color: "rgba(255,255,255,0.55)", fontSize: "0.8rem", textDecoration: "none", transition: "color 0.2s" }}
