    ...
    >
      ...
      <div style={{ height: "200px", overflow: "hidden", position: "relative" }}>
        ...
        <div style={{
          ...
          color: "#c084fc", fontSize: "0.65rem", letterSpacing: "0.08em",
        }}>
          {capacity}
        </div>
      </div>
      ...
      <div style={{ padding: "1.25rem" }}>
        <p style={{ color: "#a855f7", fontSize: "0.65rem", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: "0.3rem" }}>
          Premium Venue
        </p>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "6px", marginBottom: "1rem" }}>
          {tags.map((tag) => (
            <span key={tag} style={{
              ...
              border: "1px solid rgba(167,139,250,0.25)",
              color: "rgba(192,132,252,0.85)", letterSpacing: "0.06em",
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div>
            {hall.pricePerHead ? (
              <>
                <p style={{ color: "#c084fc", fontWeight: 600, fontSize: "0.9rem" }}>
          ...
          <button
            ...
            onMouseEnter={(e) => { e.currentTarget.style.transform = "scale(1.05)"; e.currentTarget.style.boxShadow = "0 4px 16px rgba(124,58,237,0.5)"; }}
